# Integrating GCP Cloud Run into Microsoft Sentinel
## Table of contents
- [Introduction](#intro)
- [Prerequisites](#step2)
...
## Introduction
The GCP Cloud Run Codeless Connector for Microsoft Sentinel enables seamless integration of GCP Cloud Run logs with Microsoft Sentinel without the need for custom code. Developed as part of the Codeless Connector Platform(CCP), this connector simplifies the process of collecting and ingesting Cloud Run logs from Google Cloud Platform into Microsoft Sentinel.
